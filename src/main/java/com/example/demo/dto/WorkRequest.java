...
*/
   ...
   * 開始日時(年)
   */
  @NotEmpty(message = "開始日時(年)を入力してください")
   ...
   * 開始日時(月)
   */
  @NotEmpty(message = "開始日時(月)を入力してください")
   ...
   * 開始日時(年)
   */
  @NotEmpty(message = "開始日時(日)を入力してください")
  ...
  //開始日時(時間)
   */
  @NotEmpty(message = "開始日時(時)を入力してください")
   ...
   * 開始日時(分)
   */
  @NotEmpty(message = "開始日時(分)を入力してください")
...
*/
   ...
   * 終了日時(年)
   */
  @NotEmpty(message = "終了日時(年)を入力してください")
   ...
   * 終了日時(月)
   */
  @NotEmpty(message = "終了日時(月)を入力してください")
   ...
   * 終了日時(年)
   */
  @NotEmpty(message = "終了日時(日)を入力してください")
   ...
   * 終了日時(時間)
   */
  @NotEmpty(message = "終了日時(時)を入力してください")
   ...
   * 終了日時(分)
   */
  @NotEmpty(message = "終了日時(分)を入力してください")
